    ...
    for epoch in range(20):
        ...
        with torch.no_grad():
            ...
            for (img_inputs, img_labels), (text_inputs, text_labels) in zip(img_test_loader, text_test_loader):
                ...
                print(f"predicted{predicted},text_labels{text_labels},correct{correct},total:{total}")
            ...
            print(f"y_true:{y_true},y_pred:{y_pred},len(y_true):{len(y_true)},len(y_pred):{len(y_pred)}")
            ...
            print(train_loss, train_acc, "text_test_Acc= {:.4f}".format(acc))
...
if __name__ == '__main__':
    ...
    nir_data_path = "F:/postgraduateProject/inHead/pythonProject/excel_data/self_merge_text_operation.xlsx"
    img_data_path = 'F:/postgraduateProject/inHead/pythonProject/output_graph/waveletImage/'
